...
plot1 <- pp + theme(legend.key.size = unit(0.7, "cm"), legend.text = element_text(color= "Black", size= 7), axis.text.x = element_text(color= "Black", size= 10, angle = 90), axis.text.y = element_text(size=10, angle=45)) + 
  xlab("Groups") + ylab("") + labs(fill = "Group") + 
...
group_2 <- cbind(dT,  Total) 

#Provide the column names to both groups of samples 
#colnames(group_2) <- c("dT", "rRNA", "Total")
colnames(group_2) <- c("dT", "Total")
...
#Add axis title, legend title and adjust font size 
plot2 <- pp2 + theme(legend.key.size = unit(0.7, "cm"), legend.text = element_text(color= "Black", size= 7), axis.text.x = element_text(color= "Black", size= 10, angle = 90), axis.text.y = element_text(size=10, angle=45)) + 
  xlab("Groups") + ylab("") + labs(fill = "Group") + 
  labs(title= paste(" ", title)) + 
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_y_continuous(labels = scales::comma)
...
group_3 <- cbind(dT, Total) 

#Provide the column names to both groups of samples 
#colnames(group_3) <- c("dT", "rRNA", "Total")
colnames(group_3) <- c("dT","Total")
...
#Add axis title, legend title and adjust font size 
plot3 <- pp3 + theme(legend.key.size = unit(0.7, "cm"), legend.text = element_text(color= "Black", size= 7), axis.text.x = element_text(color= "Black", size= 10, angle = 90), axis.text.y = element_text(size=10, angle=45)) +
  xlab("Groups") + ylab("") + labs(fill = "Group") + 
  labs(title= paste(" ", title)) +  
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_y_continuous(labels = scales::comma)
...
group_4 <- cbind(dT, Total) 

#Provide the column names to both groups of samples 
#colnames(group_4) <- c("dT", "rRNA", "Total")
colnames(group_4) <- c("dT", "Total")
...
#Add axis title, legend title and adjust font size 
plot4 <- pp4 + theme(legend.key.size = unit(0.7, "cm"), legend.text = element_text(color= "Black", size= 7), axis.text.x = element_text(color= "Black", size= 10, angle = 90), axis.text.y = element_text(size=10, angle=45)) +
  xlab("Groups") + ylab("") + 
...
group_5 <- cbind(dT, Total)
#Provide the column names to both groups of samples 
#colnames(group_5) <- c("dT", "rRNA", "Total")
colnames(group_5) <- c("dT", "Total")
...
#Add axis title, legend title and adjust font size 
plot5 <- pp5 + theme(legend.key.size = unit(0.7, "cm"), legend.text = element_text(color= "Black", size= 7), axis.text.x = element_text(color= "Black", size= 10, angle = 90), axis.text.y = element_text(size=10, angle=45)) + xlab("Groups") + ylab("") + labs(fill = "Group") + labs(title= paste(" ", title)) +  theme(plot.title = element_text(hjust = 0.5))
